Feature: Initializate conversation

@user1 @web
Scenario: As first user I log in and send a message to the user two
...
@user2 @web
Scenario: As two user I log in and send a message to the user one
  Given I navigate to page "https://www.messenger.com/login"
  And I wait for 5 seconds
